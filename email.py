...
f'<p> As variáveris {v1, v2} podem ser informações extraídas de algum BD ou arquivo. <p>'
f'<p> Também tem a possibilidade de automatizar o processo de downloado dos dados com a extensão {info} </p>'
